...
public class ProductModelImpl implements ProductModel {
    ...
    private final JsonNode productTreeNode;

    /**
     * Initialises the model
     * @param productRepository  JsonNode that acts as repository for product data
     * @throws ProductModelException if data is fails various validation rules
     */
    ProductModelImpl(JsonNode productRepository) throws ProductModelException {

        productTreeNode = productRepository.findValue("worksById");
     ...
     */
    private static boolean titlePartialMatch(final String partialTerm, final String target) {
     ...
     */
    @Override
    public List<Product> filterProducts(final String searchTerm) throws ProductModelException {
     ...
     */
    @Override
    public List<Product> retrieveProducts() throws ProductModelException {
